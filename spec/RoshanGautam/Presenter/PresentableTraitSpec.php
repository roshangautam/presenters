...
namespace spec\RoshanGautam\Presenter;
...
class PresentableTraitSpec extends ObjectBehavior
{
	function let()
	{
		$this->beAnInstanceOf('spec\RoshanGautam\Presenter\Foo');
	}

	function it_is_initializable()
	{
		$this->shouldHaveType('spec\RoshanGautam\Presenter\Foo');
	}
	...
	function it_throws_up_if_invalid_presenter_is_provided()
	{
		...
		$this->shouldThrow('RoshanGautam\Presenter\Exceptions\PresenterException')->duringPresent();
	}
